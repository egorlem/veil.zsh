...
Veil is **not** a plugin manager. It’s a **modular system** that breaks your `.zshrc` into **independent components**. Each module is a plain `.zsh` file — simple and easy to read or modify.
